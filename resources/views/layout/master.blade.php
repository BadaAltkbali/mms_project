...
<head>
    ...
    <!-- Google fonts - Roboto -->
    <link rel="stylesheet"
        href="{{ URL::to('assets/https://fonts.googleapis.com/css?family=Roboto:300,400,500,700') }}">
    <!-- jQuery Circle-->
    <link rel="stylesheet" href="{{ URL::to('assets/css/grasp_mobile_progress_circle-1.0.0.min.css') }}">
    <!-- Custom Scrollbar-->
    <link rel="stylesheet"
        href="{{ URL::to('assets/vendor/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.css') }}">
    <!-- theme stylesheet-->
...
<body>
    ...
    <nav class="side-navbar">
        <div class="side-navbar-wrapper">
            ...
            <div class="sidenav-header d-flex align-items-center justify-content-center">
                <!-- User Info-->
                <div class="sidenav-header-inner text-center"><img src="{{ URL::to('assets/img/avatar-7.jpg') }}"
                        alt="person" class="img-fluid rounded-circle" data-toggle="modal" data-target="#profile">
                    <h2 class="h5">Soeng Souy</h2>
                    <span>Web Developer</span>
                </div>
                <!-- Small Brand information, appears on minimized sidebar-->
                <div class="sidenav-header-logo"><a href="assets/index.html" class="brand-small text-center">
    ...
    <!-- Modal Profile-->
    <div class="modal fade" id="profile" tabindex="-1" role="dialog" style="z-index: 1050; display: none;"
        aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <div class="modal-body">
                            <div class="form-group col">
                                <div class="sidenav-header-inner"><img src="{{ URL::to('assets/img/avatar-7.jpg') }}"
                                        alt="profile" class="img-fluid rounded-circle" width="10%"></div>
                                <br>
                                <div class="row">
