...
@endif
<form action="{{ route('Adjective.store') }}" method="post" class="form-inline m-r-10" role="form"
enctype="multipart/form-data">
@csrf
<div class="form-group">
    <input type="text" class="form-control" id="AdjName" name="AdjName" placeholder="ادخل الصفه">
