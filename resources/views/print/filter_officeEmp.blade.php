...
<head>
    ...
    <title>فلترة بيانات الضباط</title>
...
<body>
    <div class="container">
        ...
        <button id="print" onclick="printout('#TablePrint')" class="btn btn-sm btn-outline-success">Print</button>
    </div>
    ...
    <script>
        ...
        function fetch(std, res) {
            $.ajax({
                url: "{{ route('prints/recordsOffice') }}",
                type: "GEt",
                data: {
                    std: std,
                    res: res
